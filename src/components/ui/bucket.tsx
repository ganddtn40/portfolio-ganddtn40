...
const INITIAL_CHIPS = [
  {
    ...
    description: "Bridging frontend & backend seamlessly",
    icon: BlockedIcon,
  },
  {
    id: 2,
    title: "Backend Architect",
    description: "Building robust APIs & databases",
    icon: ZapIcon,
  },
  {
    id: 3,
    title: "Terminal First",
    description: "Embracing the command line aesthetic",
...
export default function Bucket() {
  ...
  return (
    <div className="flex h-fit relative w-full flex-col items-center justify-center gap-4">
      <div
              ...
              {items.map((item, index) =>
                index !== 0 ? null : (
                  <m.div
                    ...
                    className="bg-card z-10 absolute flex w-[240px] origin-bottom items-center gap-2 rounded-full border border-border p-2 shadow-sm pointer-events-auto"
                  >
                    <div className="bg-muted-foreground/10 text-muted-foreground flex size-10 shrink-0 items-center justify-center rounded-full">
